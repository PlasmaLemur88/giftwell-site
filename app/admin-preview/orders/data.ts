...
export const ORDERS: Order[] = [
  { id: '33931', sender: 'Tom Reyes',        email: 'tom@summitcg.co',     company: 'Summit Consulting Group', orderDate: 'Apr 03, 2026', targetShipping: 'Apr 04, 2026', amount: '$343.90',   amountNum: 343.90,  recipients: 1,  status: 'Completed', budgetPerRecipient: '$80',  categories: ['Pantry', 'Wellness'],                          message: 'Thanks for closing the Q1 deal. Pick something you\'ll love.',                 theme: 'Hand-drawn Confetti',       occasion: 'Client appreciation' },
  { id: '33912', sender: 'Sarah Chen',       email: 'sarah@halcyon.io',    company: 'Halcyon Labs',           orderDate: 'Apr 02, 2026', targetShipping: 'Apr 04, 2026', amount: '$684.50',   amountNum: 684.50,  recipients: 2,  status: 'Shipped',   budgetPerRecipient: '$60',  categories: ['Pantry', 'Drinkware'],                         message: 'Welcome to Halcyon. Stay caffeinated.',                                         theme: 'Soft Petals',               occasion: 'New hire' },
  { id: '32933', sender: 'Riley Lopez',      email: 'riley@northforge.co', company: 'NorthForge',             orderDate: 'Mar 22, 2026', targetShipping: 'Mar 23, 2026', amount: '$453.90',   amountNum: 453.90,  recipients: 1,  status: 'Completed', budgetPerRecipient: '$100', categories: ['Wellness'],                                    message: 'For all the late-night sprints. Thanks for everything.',                       theme: 'Midnight Stars',            occasion: 'Project complete' },
  { id: '32826', sender: 'Robert Schox',     email: 'rs@parallelpath.com', company: 'Parallel Path',          orderDate: 'Mar 20, 2026', targetShipping: 'Mar 21, 2026', amount: '$1,827.03', amountNum: 1827.03, recipients: 3,  status: 'Completed', budgetPerRecipient: '$120', categories: ['Pantry', 'Wellness', 'Apparel'],               message: 'You three made our launch happen. Pick whatever sparks joy.',                  theme: 'Linen Texture',             occasion: 'Team milestone' },
  { id: '32702', sender: 'Marcus Liu',       email: 'marcus@truebay.co',   company: 'Truebay',                orderDate: 'Mar 18, 2026', targetShipping: 'Mar 24, 2026', amount: '$1,212.40', amountNum: 1212.40, recipients: 4,  status: 'Pending',   budgetPerRecipient: '$80',  categories: ['Pantry'],                                      message: 'Onboarding gift from the Truebay team. Welcome aboard!',                       theme: 'Block Color',               occasion: 'New hire batch' },
  { id: '32445', sender: 'Priya Patel',      email: 'priya@orbitlabs.io',  company: 'Orbit Labs',             orderDate: 'Mar 14, 2026', targetShipping: 'Mar 18, 2026', amount: '$5,840.00', amountNum: 5840.00, recipients: 12, status: 'Completed', budgetPerRecipient: '$100', categories: ['Pantry', 'Wellness', 'Apparel', 'Drinkware'],  message: 'You all crushed this quarter. Take your pick from the catalog.',               theme: 'Hand-drawn Confetti',       occasion: 'Q1 bonus' },
  { id: '32102', sender: 'Jordan Park',      email: 'jp@flintstudio.co',   company: 'Flint Studio',           orderDate: 'Mar 09, 2026', targetShipping: 'Mar 10, 2026', amount: '$135.50',   amountNum: 135.50,  recipients: 1,  status: 'Cancelled', budgetPerRecipient: '$60',  categories: ['Pantry'],                                      message: '',                                                                              theme: 'Soft Petals',               occasion: 'Birthday' },
  { id: '31872', sender: 'Alex Kim',         email: 'alex@brightway.so',   company: 'Brightway',              orderDate: 'Mar 05, 2026', targetShipping: 'Mar 06, 2026', amount: '$894.20',   amountNum: 894.20,  recipients: 2,  status: 'Completed', budgetPerRecipient: '$120', categories: ['Apparel', 'Drinkware'],                        message: 'Thanks for the referral. A little something for both of you.',                 theme: 'Linen Texture',             occasion: 'Referral thanks' },
  { id: '31077', sender: 'Haipeng Wei',      email: 'haipeng@arclite.co',  company: 'Arclite',                orderDate: 'Feb 23, 2026', targetShipping: 'Feb 24, 2026', amount: '$294.40',   amountNum: 294.40,  recipients: 1,  status: 'Completed', budgetPerRecipient: '$80',  categories: ['Wellness'],                                    message: 'Hope this finds you well.',                                                     theme: 'Midnight Stars',            occasion: 'Just because' },
  { id: '30822', sender: 'Lauren Mitchell',  email: 'lm@everbloom.shop',   company: 'Everbloom',              orderDate: 'Feb 18, 2026', targetShipping: 'Feb 19, 2026', amount: '$2,418.60', amountNum: 2418.60, recipients: 6,  status: 'Completed', budgetPerRecipient: '$100', categories: ['Pantry', 'Wellness'],                          message: 'Your work this season was remarkable. Thank you.',                              theme: 'Block Color',               occasion: 'End of season' },
  { id: '30501', sender: 'Diego Vargas',     email: 'diego@meridian.co',   company: 'Meridian',               orderDate: 'Feb 12, 2026', targetShipping: 'Feb 13, 2026', amount: '$748.90',   amountNum: 748.90,  recipients: 2,  status: 'Shipped',   budgetPerRecipient: '$120', categories: ['Apparel'],                                     message: 'New offsite, new gear. See you in Tahoe.',                                     theme: 'Hand-drawn Confetti',       occasion: 'Offsite kickoff' },
  { id: '28789', sender: 'Daniel Seminara',  email: 'daniel@seminara.io',  company: 'Seminara Holdings',      orderDate: 'Jan 27, 2026', targetShipping: 'Jan 28, 2026', amount: '$312.06',   amountNum: 312.06,  recipients: 1,  status: 'Completed', budgetPerRecipient: '$80',  categories: ['Pantry', 'Wellness'],                          message: 'A small token of appreciation for your help.',                                  theme: 'Soft Petals',               occasion: 'Thank you' },
];
