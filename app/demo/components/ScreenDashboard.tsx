...
const MOCK_ORDERS = [
  { name: 'Sarah Johnson', id: 'GW-1234', qty: 124, status: 'Sent', color: '#A2DB39' },
  { name: 'Mike Chen', id: 'GW-1235', qty: 48, status: 'Scheduled', color: '#FBBF24' },
  { name: 'Lisa Park', id: 'GW-1236', qty: 89, status: 'Delivered', color: '#5B64F9' },
];
...
export default function ScreenDashboard({ store, onNext }: { store: StoreData; onNext: () => void }) {
  void store;
  return (
    <div className="demo-site-container">
      <div className="screen-dashboard-dark">
        <div className="dashboard-dark-header"><h2>Dashboard</h2></div>
