...
Merchants can customize **three surfaces only**, everything else is Giftwell-locked. This is intentional. It keeps the experience consistent across merchants and avoids per-template tinkering hell.
